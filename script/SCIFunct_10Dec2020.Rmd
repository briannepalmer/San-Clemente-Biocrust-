...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/chlorophyll_grid.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/chlorophyll_grid_pge.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/chlorophyll_grid_pgw.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/chlorophyll_grid_rc.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/eps_grid.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/eps_grid_pge.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/eps_grid_pgw.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/eps_grid_rc.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/n_shift_grid.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/n_shift_grid_pge.pdf", width = 8, height = 4)
ggplot(data=data_summary(nfix.no.out, varname="shift", 
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/n_shift_grid_pgw.pdf", width = 8, height = 4)
ggplot(data=data_summary(nfix.no.out, varname="shift", 
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/n_shift_grid_rc.pdf", width = 8, height = 4)
ggplot(data=data_summary(nfix.no.out, varname="shift", 
...
c_shift_summary <- data_summary(c_shift, varname="shift_C", 
                    groupnames=c("Site", "Treatment", "Year"))
pdf("vc_shift_grid.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/c_shift_grid_pge.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/c_shift_grid_pgw.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/c_shift_grid_rc.pdf", width = 8, height = 4)
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/nfix_grid.pdf", width = 8, height = 4)
ggplot(data=data_summary(nfix.no.out, varname="shift", 
...
pdf("C:/Users/Brianne/Documents/San-Clemente-Biocrust-/figures/c_shift_grid.pdf", width = 8, height = 4)
...
chl$year <- as.factor(chl$year)
chl$chl_total_mg_per_g <- as.numeric(chl$chl_total_mg_per_g)
# remove NAs
chl <- chl[-c(35,39,47,75:78,82,88,93,95,99,101,112),]

chl_short <- chl %>% group_by(year,fire.type, site) %>% summarize_at(vars(chl_total_mg_per_g),list(mean = mean))
chl_short<- chl_short %>% dplyr::rename(total_chl = mean)
chl_short <- chl_short[-12,]
...
nfix_short <- nfix %>% group_by(FireType, Year, Site)%>% summarize_at(vars(c(X.N_Inc:Total_C_Cont, shift_N:shift_CN)),list(mean = mean))
nfix_short<- nfix_short %>% dplyr::rename(fire.type = FireType, year = Year, site = Site)
nfix_short <- nfix_short[-12,]

macro_short <- macro %>% group_by(Site, Treatment, Sample.Year) %>% summarize_at(vars(cyano:Total),list(mean = mean)) %>% filter(Sample.Year != "2020", Treatment != "rx/wild")
...
nfix.macro.mod <- glm(Total_mean ~ shift_N_mean, data = labfunct)
