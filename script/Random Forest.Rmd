...
bsc_macro <- bsc_macro %>% rename(uclassified_Verruvomicrobia = unclassified..derived.from.Verrucomicrobia.subdivision.3.)
bsc_macro <- bsc_macro %>% rename(uclassified_Gammaproteobacteria = unclassified..derived.from.Gammaproteobacteria.)
...
rf <- randomForest(Total ~ ., ntree = 1000, importance = TRUE, data = macro_plant[c(1,2,9,18:61)])
print(rf)
varImpPlot(rf,type=1)
importanceOrder=order(-rf$importance)
names=rownames(rf$importance)[importanceOrder]

rf_pred <- predict(rf, macro_plant[c(1,2,9,18:61)]) # predictions
...
rf <- randomForest(Total ~ ., ntree = 1000, importance = TRUE, data = macro_plant[c(9,18:61)])
print(rf) 
varImpPlot(rf,type=1)
importanceOrder=order(-rf$importance)
names=rownames(rf$importance)[importanceOrder]

rf_pred <- predict(rf, macro_plant[c(9,18:61)]) # predictions
caret::postResample(rf_pred, macro_plant$Total)
...
rf <- randomForest(Total ~ ., ntree = 1000, importance = TRUE, data = macro_plant[c(1,2,9,14:17)])
print(rf)   
varImpPlot(rf,type=1)

rf_pred <- predict(rf, macro_plant[c(1,2,9,14:17)]) # predictions
caret::postResample(rf_pred, macro_plant$Total)
...
rf <- randomForest(Total ~ ., ntree = 1000, importance = TRUE, data = macro_plant[c(9,14:17)])

print(rf)   
VI_F = importance(rf)
varImpPlot(rf,type=1)

rf_pred <- predict(rf, macro_plant[c(9,14:17)]) # predictions
caret::postResample(rf_pred, macro_plant$Total)
...
rf <- randomForest(Total ~ ., ntree = 1000, importance = TRUE, data = bsc_macro[c(1:202, 211)])
print(rf)
varImpPlot(rf,type=1)

rf_pred <- predict(rf,bsc_macro[c(1:202, 211)]) # predictions
...
rf <- randomForest(Total ~ ., ntree = 1000, importance = TRUE, data = macro_bulk[c(1,2,9,12:211)])
print(rf)
varImpPlot(rf,type=1)

rf_pred <- predict(rf,macro_bulk[c(1,2,9,12:211)]) # predictions
...
macro$treatment <- c("none","none","none", "none", "none", "none", "none", "none", "none", "none","none", "none", "none", "none", "none", "none", "none", "none", "none", "none", "none", "none","none","none", "none", "none", "none", "none", "none", "none", "none","none", "none", "none", "none", "none", "none", "none", "none", "none" ,"burn","burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","none","none","none", "none", "none", "none", "none", "none", "none", "none","none", "none", "none", "none", "none", "none", "none", "none", "none", "none", "none", "none","none","none", "none", "none", "none", "none", "none", "none", "none","none", "none", "none", "none", "none", "none", "none", "none", "none" ,"burn","burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","none","none","none", "none", "none", "none", "none", "none", "none", "none","none", "none", "none", "none", "none", "none", "none", "none", "none", "none", "none", "none","none","none", "none", "none", "none", "none", "none", "none", "none","none", "none", "none", "none", "none", "none", "none", "none", "none" ,"burn","burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn","burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn", "burn")
...
rf <- randomForest(treatment ~ ., ntree = 1000, importance = TRUE, data = train[c(5,6,7,9,10)])
print(rf)
varImpPlot(rf)
predicion_for_table <- predict(rf, test[,-10])
table(observed = test[,10], predicted = predicion_for_table)
